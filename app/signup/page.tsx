    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Start your free 30-day trial. Cancel anytime.</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              <input
                ...
                className="w-4 h-4 rounded border-slate-300 text-purple-600 focus:ring-purple-600 mt-1"
              />
          ...
          <div className="space-y-3">
            <button
              type="button"
              className="w-full flex items-center justify-center gap-2 px-4 py-3 border border-slate-200 rounded-lg hover:bg-slate-50 transition font-medium text-slate-700"
            >
            ...
            >
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M17.05 13.5c-.91 0-1.64.46-2.05 1.09h-.03c-.42-.72-1.12-1.09-2.05-1.09-1.42 0-2.61 1.26-2.61 2.9 0 1.64 1.19 2.9 2.61 2.9.93 0 1.63-.37 2.05-1.09h.03c.41.72 1.14 1.09 2.05 1.09 1.42 0 2.61-1.26 2.61-2.9 0-1.64-1.19-2.9-2.61-2.9zm-2.05 4.34c-.77 0-1.38-.6-1.38-1.44 0-.84.61-1.44 1.38-1.44.77 0 1.38.6 1.38 1.44 0 .84-.61 1.44-1.38 1.44zm2.05-1.44c0 .84.61 1.44 1.38 1.44.77 0 1.38-.6 1.38-1.44 0-.84-.61-1.44-1.38-1.44-.77 0-1.38.6-1.38 1.44z" />
              </svg>
              Sign up with Apple
            </button>
          </div>
